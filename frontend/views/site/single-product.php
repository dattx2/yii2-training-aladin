...
<div class="single-product-details">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="single-product-img tab-content">
                    ...
                    <div class="single-pro-main-image tab-pane active" id="pro-large-img-1">
                        <a href="#"><img class="optima_zoom" src="<?=$values['Link'] ?>" data-zoom-image="<?=$values['Link'] ?>" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-2">
                        <a href="#"><img class="optima_zoom" src="<?=$values['Link'] ?>" data-zoom-image="img/product/2.png" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-3">
                        <a href="#"><img class="optima_zoom" src="<?=$values['Link'] ?>" data-zoom-image="img/product/8.png" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-4">
                        <a href="#"><img class="optima_zoom" src="<?=$values['Link'] ?>" data-zoom-image="img/product/1.png" alt="optima"/></a>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="single-product-details">
                    <a href="#" class="product-name"><?=$values['name'] ?></a>
...
<!--                                 Product Description-->
                        ...
                        <div role="tabpanel" class="" id="tab3">
                            <div class="single-p-tab-content">
                    ...
                    <div class="single-product">
                        <div class="product-img">
                            <a href="single-product.html">
                                <img src="<?=$data['Link']?>" alt="" class="primary-img">
                                <img src="<?=$data['Link']?>" alt="" class="secondary-img">
                            </a>
                        </div>
                        <div class="product-price">
                            <div class="product-name">
                                <a href="single-product?id=<?=$data['id'] ?>" title="Fusce aliquam"><?=$data['name']?></a>
                            </div>
                            <div class="price-rating">
                                <span>$170.00</span>
                            </div>
